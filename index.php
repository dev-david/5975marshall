				...
				<!-- Intro -->
					<section id="top" class="one">
						<div class="container">
							...
							<header>
								<h3 class="alt">Thinking about selling <span class="blackblock"> 5975 Marshall St?</span> Let us help! Team Fast Agents is YOUR personal team of professionals who makes Real Estate <span class="blueblock">EASY</span> for <span class="greenblock">YOU.</span></h3>
							</header>
					...
					<section id="about" class="three">
						<div class="container">
							<header>
								...
								<h3 style="color: #ecf0f1;">Properties sold within area of 5975 Marshall St</h3>
							</header>
							<div class="row">
								<div class="4u">
									<article class="item">
